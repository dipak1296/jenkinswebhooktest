...
<body id="sample">
  <div class="textColumn">
    ...
    <p>Your first HTTPS AWS Elastic Beanstalk Python Application Deployed through Jenkins is now running on your own dedicated environment in the AWS Cloud</p>
